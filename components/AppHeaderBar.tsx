...
function AppHeaderBar(props: AppHeaderBarProps) {
  // Destructuring props
  const { title, titleColor, onIconPress, backgroundColor, isHeaderVisible, style } = props;
  ...
  return !isHeaderVisible ? null : (
    ...
    >
      ...
      />
      <AppText text={title} size={25} marginLeft={15} color={titleColor ? titleColor : undefined} />
    </AnimatedView>
  );
}
