...
import { IconNames } from '../../constants/ui';
import { useAppSelector } from '../../store/storeHooks';

// Icon component
function Icon(props: AppIconProps): JSX.Element {
  // Destructuring props
  const { family, style, onPress, loading, color, margins, themeColors, size, ...otherProps } =
    props;
  ...
  if (loading)
    return <ActivityIndicator color={IconColor} size={'small'} style={seperateMargins} />;
